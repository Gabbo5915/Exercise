ChatEngine = ChatEngineCore.create({
    publishKey: 'pub-c-2a215bc1-60a7-44a0-9fa0-c6d4dcc350cf',
    subscribeKey: 'sub-c-9a75b2ce-36c5-11e9-9010-ca52b265d058',
...
const init = () => {
    ...
    ChatEngine.on('$.ready', function (data) {
        ...
        myChat = new ChatEngine.Chat('chatengine-demo');
